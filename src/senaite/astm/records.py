...
#: +-----+--------------+---------------------------------+---------------------+
#: |   3 |       12.1.3 |        Starting Range ID Number |      starting_range |
#: +-----+--------------+---------------------------------+---------------------+
#: |   4 |       12.1.4 |          Ending Range ID Number |        ending_range |
#: +-----+--------------+---------------------------------+---------------------+
#: |   5 |       12.1.5 |               Universal Test ID |             test_id |
#: +-----+--------------+---------------------------------+---------------------+
#: |   6 |       12.1.6 |   Nature of Request Time Limits |         time_limits |
#: +-----+--------------+---------------------------------+---------------------+
#: |   7 |       12.1.7 | Beginning Request Results Date  |   beginning_results |
#: |     |              | and Time                        |                     |
#: +-----+--------------+---------------------------------+---------------------+
#: |   8 |       12.1.8 | Ending Request Results Date and |      ending_results |
#: |     |              | Time                            |                     |
#: +-----+--------------+---------------------------------+---------------------+
#: |   9 |       12.1.9 |       Requesting Physician Name |      physician_name |
#: +-----+--------------+---------------------------------+---------------------+
#: |  10 |      12.1.10 | Requesting Physician Telephone  | physician_telephone |
#: |     |              | Number                          |                     |
#: +-----+--------------+---------------------------------+---------------------+
#: |  11 |      12.1.11 |             User Field Number 1 |        user_field_1 |
#: +-----+--------------+---------------------------------+---------------------+
#: |  12 |      12.1.12 |             User Field Number 2 |        user_field_2 |
#: +-----+--------------+---------------------------------+---------------------+
#: |  13 |      12.1.13 | Request Information Status Code |         status_code |
#: +-----+--------------+---------------------------------+---------------------+
